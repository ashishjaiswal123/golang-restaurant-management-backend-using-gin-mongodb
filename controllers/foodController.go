...
func GetFoods() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		defer cancel()
		if err != nil {
			c.JSON(http.StatusInternalServerError, gin.H{"error": "error occured while fecthing the food items"})
		}
...
// Getting food by food ID from DB
...
// Creating food in DB and also checking menuID does exists for food or not
...
// updating food item with food ID in DB
